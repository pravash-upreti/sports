...
const TournamentListItem = props => {
  ...
  return (
    <li className="tournament-list__item">
      <div className="tournament-list__item--score-time">Full Time</div>
      ...
      <div className="tournament-list__item--team-block tournament-list__item--team-block-left">
        ...
        <div className="tournament-list__item--team-left-score">{listItem.firstTeam.score}</div>
      </div>
      <div className="tournament-list__item--separator">-</div>
      <div className="tournament-list__item--team-block tournament-list__item--team-block-right tournament-list__item--team-winner">
        <div className="tournament-list__item--team-right-score">{listItem.secondTeam.score}</div>
      ...
      <div className="tournament-list__item--half-time">
        ...
        <span className="score">
          {listItem.halfTimeScore.firstTeam} - {listItem.halfTimeScore.secondTeam}
        </span>
      </div>
    </li>
  );
